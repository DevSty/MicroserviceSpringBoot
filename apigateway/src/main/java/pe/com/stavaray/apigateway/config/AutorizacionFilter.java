package pe.com.stavaray.apigateway.config;
...
import pe.com.stavaray.apigateway.dto.RequestDto;
import pe.com.stavaray.apigateway.dto.TokenDto;
    ...
    public GatewayFilter apply(Config config) {
        return (((exchange, chain) -> {
            ...
            return webClient.build()
                    .post()
                    .uri("http://autentication/api/autentication/validar?token=" + chunks[1])
